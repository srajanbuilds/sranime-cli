...
- Appease the linter (run `shfmt -i 4 -ci -d -w sranime-cli`)
- Appease POSIX (run `shellcheck -s sh -o all -e 2250 sranime-cli`)
- Bump the version
...
- When requesting a feature, check it hasn't been [rejected](https://github.com/srajanbuilds/sranime-cli/issues/523) previously
